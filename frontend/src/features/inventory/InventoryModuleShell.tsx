...
const topNavItems = [
  { to: adminRoutes.dashboard, label: "T\u1ed5ng quan", end: true },
  { to: adminRoutes.products, label: "H\u00e0ng h\u00f3a" },
  { to: adminRoutes.invoices, label: "B\u00e1n h\u00e0ng" },
  { to: adminRoutes.orders, label: "\u0110\u1eb7t h\u00e0ng" },
  { to: adminRoutes.history, label: "L\u1ecbch s\u1eed" },
  { to: adminRoutes.customers, label: "Kh\u00e1ch h\u00e0ng" },
  { to: adminRoutes.reports, label: "B\u00e1o c\u00e1o" },
  { to: adminRoutes.settings, label: "C\u00e0i \u0111\u1eb7t" },
] as const;
